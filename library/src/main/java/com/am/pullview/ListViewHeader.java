...
public class ListViewHeader extends LinearLayout {
    ...
    private void initView(Context context) {
        ...
        WidgetUtil.setPadding(headerView, 0, 10, 0, 10);

        //显示箭头与进度
        FrameLayout headImage = new FrameLayout(context);
        arrowImageView = new ImageView(context);
        //从包里获取的箭头图片
        arrowImage = WidgetUtil.getBitmapFromSrc("image/arrow.png");
        ...
        WidgetUtil.setPadding(headTextLayout, 0, 0, 0, 0);
        ...
        WidgetUtil.setTextSize(tipsTextview, 30);
        WidgetUtil.setTextSize(headerTimeView, 27);
        ...
        layoutParamsWW3.rightMargin = WidgetUtil.scaleValue(mContext, 10);
